...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#040228] flex justify-center items-center p-4 m-t-2'>
      <form method='POST' action='https://getform.io/f/012b67ef-e1ef-4d38-88ab-716f10191dee' className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-8'>
            ...
            <p className='text-white py-4'> Submit form below or send me an email at nurfateemah03@gmail.com</p>
        </div>
        ...
        <textarea className='bg-[#b7b2c42f]' name="message" rows="5" placeholder=' Message'></textarea>
